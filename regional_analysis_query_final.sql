...
SELECT
  ...
  ROUND(AVG(cs.patient_survey_star_rating),2) AS avg_patient_survey_star_rating,
  ROUND(AVG(AVG(ch.hospital_overall_rating)) OVER(),2) AS national_avg_rating,
